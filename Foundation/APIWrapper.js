...
Score Tracking
*******************************************/
function BVScorm_score(score){var api=getAPIHandle();if(api==null)
{return!1}
else{var result;var res=doLMSSetValue("cmi.core.score.raw",score);doLMSSetValue("cmi.core.score.min","0")
doLMSSetValue("cmi.core.score.max","100")
res=doLMSCommit("")}}

// Incomplited Course

function BVScorm_score1(score) {
	var api = getAPIHandle();
   if (api == null)
   {
      //alert("Unable to locate the LMS's API Implementation.\nLMSIsInitialized() failed.");
   ...
   {
			var result;
			var res =doLMSSetValue("cmi.core.score.raw", score);
...
var api = getAPIHandle();
   ...
   {
		var res =doLMSGetValue("cmi.core.score.raw");
		return res;
	}
}
/*******************************************************************/
